...
\cvline{Expert}{C, C++}
\cvline{Intermediate}{Python, Java, Bash}
\cvline{Basic}{LaTeX}
\subsection{Tools}
\cvline{}{gcc, bison, flex, cmake, git, svn, ant, maven}

\section{Computer skills}
\cvline{IDE}{Xcode, QtCreator, Eclipse}
\cvline{OS}{Linux (RedHat, Debian), MacOS X}
